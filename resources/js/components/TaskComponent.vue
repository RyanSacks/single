...
<template>
    <div>
        ...
        <div v-else>
            <button @click="loadCreateModal" class="btn btn-primary btn-block">Add New Tasks</button>
    ...
    export default {
        ...
        data(){
          ...
          return {
              ...
              tasks: [],
              uri: 'http://todosingle.test/tasks',
              errors: [],
              new_update_task: [],
              image: 'images/loader2.gif',
              loading: false,
